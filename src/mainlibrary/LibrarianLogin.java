...
// TODO add your handling code here:
        ...
        if (Uname.isEmpty() || Pass.isEmpty()) {
            ...
            LibrarianLogin.this,
            "Username and Password are required.", "Login Error!", JOptionPane.ERROR_MESSAGE
        );
        return;
        } 
        // Check Special Characters Presence
        if (containsBlacklistedCharacters(Uname)) 
        {
            JOptionPane.showMessageDialog(
            LibrarianLogin.this,
    ...
    private boolean containsBlacklistedCharacters(String input) {
    String[] blacklistedCharacters = {"<", ">", "'",",","/","\\",";","||","--","#"};
        for (String character : blacklistedCharacters) {
